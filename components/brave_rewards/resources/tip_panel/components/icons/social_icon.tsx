...
export function TwitchIcon () {
  return (
    <svg className='icon' fill='none' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 18 18'>
      <path d='M4.5.75h12l-.375 7.875L10.5 14.25h-6V.75Z' fill='#fff'/>
      <path fillRule='evenodd' clipRule='evenodd' d='M1.28613 3.21429 4.50042 0H16.7147v9l-5.7857 5.7857H8.35756L5.14328 18v-3.2143H1.28613V3.21429ZM12.8576 10.9286l2.5714-2.57146V1.28571H5.14328v9.64289h2.89285v2.25l2.24997-2.25h2.5715Zm.6429-7.39291h-1.2857v3.85715h1.2857V3.53569Zm-3.53573.00004H8.67905v3.85714h1.28572V3.53573Z' fill='#6B7084'/>
    </svg>
  )
}
