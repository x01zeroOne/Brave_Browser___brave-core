...
TEST(ParseDappListsUnitTest, ParseDappLists) {
  ...
  EXPECT_TRUE(ParseDappLists(chain_list, &dapp_list_map));
  ...
  EXPECT_EQ(eth_dapp->metrics->transactions, 2348167u);
  EXPECT_EQ(eth_dapp->metrics->uaw, 387445u);
  EXPECT_DOUBLE_EQ(eth_dapp->metrics->volume, 65982226285.39);
  EXPECT_DOUBLE_EQ(eth_dapp->metrics->balance, 1904817795.53);
  ...
  EXPECT_EQ(sol_dapp->metrics->transactions, 401926u);
  EXPECT_EQ(sol_dapp->metrics->uaw, 354495u);
  EXPECT_DOUBLE_EQ(sol_dapp->metrics->volume, 8949.83);
  EXPECT_DOUBLE_EQ(sol_dapp->metrics->balance, 3.81);
}
