...
// utils
import { createMockStore, renderHookOptionsWithMockStore } from '../../utils/test-utils'
import { deserializeTransaction, makeSerializableTransaction } from '../../utils/model-serialization-utils'

// hooks
import { useTransactionQuery } from './use-transaction'
...
describe('useTransactionQuery', () => {
  it('finds a transaction from the cache', async () => {
    ...
    // loaded
    expect(hook.result.current.transaction).toBeDefined()
