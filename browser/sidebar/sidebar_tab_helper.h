...
#ifndef BRAVE_BROWSER_SIDEBAR_SIDEBAR_TAB_HELPER_H_
#define BRAVE_BROWSER_SIDEBAR_SIDEBAR_TAB_HELPER_H_
...
class SidebarTabHelper : public content::WebContentsUserData<SidebarTabHelper> {
 public:
  ...
  absl::optional<sidebar::SidebarItem::BuiltInItemType> active_panel() {
...
#endif  // BRAVE_BROWSER_SIDEBAR_SIDEBAR_TAB_HELPER_H_
